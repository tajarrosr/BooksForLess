@include('partials.__header')
    ...
    <main class="container w-full transition duration-500 ease-in-out m-auto">
        <header>
            <h1 class="uppercase text-4xl text-text-900">browse books</h1>
        ...
        <div class="card">
            <h1 class="uppercase text-4xl text-text-900">Card</h1>
        ...
        <section class="grid-container grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 auto-rows-auto">
            ...
            <div class="bg-accent-200 shadow-md rounded-lg p-4">
                ...
                <button class="bg-primary-500 text-text-50 px-4 py-2 mt-4 rounded hover:bg-primary-600"><a href="#">Add to Cart</a></button>
            </div>
            @endforeach
        </section>
    </main>
