...
<body class="bg-background-100 min-h-screen overflow-y-hidden">

    <x-navConfirmed/>
    <div class="flex justify-center bg-background-100 min-h-screen">
        <!-- Left side with the image -->
        <div class="w-1/2 h-full">
            <img src="/assets/images/check-out/delivery.jpg" alt="Delivery Image" class="object-cover h-full w-full">
        </div>
        <!-- Right side with the thank you message -->
        <div class="w-1/2 flex bg-background-100 h-screen">
            <div class="bg-background-50 p-8 text-center">
                <h1 class="text-xl font-semibold text-gray-800 mb-4 mt-32">Thank You for Your Order!</h1>
                ...
                <div class="flex flex-row justify-center items-center space-x-4 mb-4 mt-5">
                    ...
                    <a href="https://www.twitter.com" class="text-gray-500 hover:text-gray-700">
